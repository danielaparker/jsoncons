...
namespace jmespath {
    ...
    public:
        ...
        public:
            ...
            virtual reference evaluate(reference val, jmespath_storage&, std::error_code& ec) const = 0;
        };
        ...
        class not_expression : public unary_operator
        {
            ...
            reference evaluate(reference val, jmespath_storage&, std::error_code&) const override
            {
        ...
        public:
            ...
            token(const unary_operator* oper)
                : type_(token_type::unary_operator), 
                  unary_operator_(oper)
            {
            }
        ...
        public:
            ...
            const unary_operator* get_not_expression() const
            {
                return &not_expr_;
            }
