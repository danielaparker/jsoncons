...
class basic_csv_cursor : public ser_context
{
public:
...
public:
    basic_csv_cursor()
       : basic_csv_cursor(basic_csv_decode_options<CharT>())
    {
    }

    explicit basic_csv_cursor(const TempAlloc& alloc)
       : basic_csv_cursor(basic_csv_decode_options<CharT>(), 
                          default_csv_parsing(),
                          alloc)
    {
    ...
    explicit basic_csv_cursor(const basic_csv_decode_options<CharT>& options)
        : basic_csv_cursor(options, TempAlloc{})
    {
    }

    basic_csv_cursor(const basic_csv_decode_options<CharT>& options,
    ...
    basic_csv_cursor(std::function<bool(csv_errc,const ser_context&)> err_handler,
