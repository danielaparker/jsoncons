...
namespace jsonschema {
    ...
    private:
        ...
        {
            jsonpointer::json_pointer this_path = eval_path / this->keyword_name();
            ...
            referred_schema_->validate(this_path, instance, instance_location, evaluated_properties, reporter, patch);
        }
    };
    ...
    private:
        ...
        void do_resolve_recursive_refs(const uri& /*base*/, bool /*has_recursive_anchor*/, schema_registry<Json>& /*schemas*/) override
        {
            ...
            referred_schema_ = schemas.get_schema(location)->make_copy();
            referred_schema_->resolve_recursive_refs(base, has_recursive_anchor, schemas);
            ...
            Json& patch) const override
        {
            ...
            referred_schema_->validate(eval_path, instance, instance_location, evaluated_properties, reporter, patch);
        }
    };
    ...
    private:
            ...
            Json&) const final
        {
            ...
            if (format_check_ != nullptr) 
            {
                ...
                format_check_(this_path, this->schema_path(), instance_location, s, reporter);
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            ...
            {
                item_validators.push_back(validator->make_copy());
            }
            schema_validator_type additional_items_validator; 
            
            if (additional_items_validator_)
            {
                additional_items_validator = additional_items_validator_->make_copy();
            }
    ...
    private:
            ...
            Json& patch) const final
        {
            ...
            for (const auto& item : instance.array_range()) 
            {
                ...
                {
                    pointer /= index++;
                    (*validator_it)->validate(this_path, item, pointer, evaluated_properties, reporter, patch);
                    ++validator_it;
                }
                else if (additional_items_validator_ != nullptr)
                {
                    pointer /= index++;
                    additional_items_validator_->validate(this_path, item, pointer, evaluated_properties, reporter, patch);
                }
                else
                    break;
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            ...
            if (validator_)
            {
                validator = validator_->make_copy();
            }

            return jsoncons::make_unique<contains_validator>(this->schema_path(),
                std::move(validator));
        }
            ...
            Json& patch) const final
        {
            ...
            if (validator_) 
            {
                ...
                for (const auto& item : instance.array_range()) 
                {
                    ...
                    validator_->validate(this_path, item, instance_location, evaluated_properties, local_reporter, patch);
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            ...
            if (items_validator_)
            {
                items_validator = items_validator_->make_copy();
            }
            return jsoncons::make_unique<items_object_validator>(this->schema_path(),
            ...
            Json& patch) const final
        {
            ...
            if (items_validator_)
            {
                for (const auto& item : instance.array_range()) 
                {
                    jsonpointer::json_pointer pointer(instance_location);
                    pointer /= index;
                    items_validator_->validate(this_path, item, pointer, evaluated_properties, reporter, patch);
                    index++;
                }
            }
        }
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            return jsoncons::make_unique<unique_items_validator>(this->schema_path(),
                are_unique_);
        }
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            return jsoncons::make_unique<min_length_validator>(this->schema_path(),
                min_length_);
        }
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            ...
            if (rule_)
            {
                rule = rule_->make_copy();
            }

            return jsoncons::make_unique<not_validator>(this->schema_path(),
                std::move(rule));
        }
    ...
    private:
            ...
            Json& patch) const final
        {
            ...
            collecting_error_reporter local_reporter;
            rule_->validate(this_path, instance, instance_location, evaluated_properties, local_reporter, patch);
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            ...
            return jsoncons::make_unique<combining_validator>(this->schema_path(),
                std::move(validators));
        }
    ...
    private:
            ...
            Json& patch) const final
        {
            ...
            for (std::size_t i = 0; i < validators_.size(); ++i) 
            {
                jsonpointer::json_pointer item_path{this_path};
                item_path.append(i);

                std::size_t mark = local_reporter.errors.size();
                validators_[i]->validate(item_path, instance, instance_location, evaluated_properties, local_reporter, patch);
                if (!is_complete)
                {
                    if (mark == local_reporter.errors.size())
                        count++;
                    if (Criterion::is_complete(item_path, instance, instance_location, reporter, local_reporter, count))
                        is_complete = true;
                }
            }
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            return jsoncons::make_unique<maximum_validator>(this->schema_path(),
                value_);
        }
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            return jsoncons::make_unique<exclusive_maximum_validator>(this->schema_path(),
                value_);
        }
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            ...
            return jsoncons::make_unique<minimum_validator>(this->schema_path(),
                value_);
        }
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            return jsoncons::make_unique<exclusive_minimum_validator>(this->schema_path(),
                value_);
        }
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            return jsoncons::make_unique<multiple_of_validator>(this->schema_path(),
                value_);
        }
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            return jsoncons::make_unique<required_validator>(this->schema_path(),
                items_);
        }
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            ...
            return jsoncons::make_unique<unevaluated_properties_validator>(this->schema_path(),
                std::move(validator));
        }
            ...
            if (validator_)
            {
                ...
                for (const auto& prop : instance.object_range()) 
                {
                    ...
                    if (prop_it == evaluated_properties.end()) 
                    {
                        ...
                        validator_->validate(this_path, prop.value() , instance_location, evaluated_properties, reporter, patch);
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            ...
            if (if_validator_)
            {
                if_validator = if_validator_->make_copy();
            }
            schema_validator_type then_validator;
            if (then_validator_)
            {
                then_validator = then_validator_->make_copy();
            }
            schema_validator_type else_validator;
            if (else_validator_)
            {
                else_validator = else_validator_->make_copy();
            }

            return jsoncons::make_unique<conditional_validator>(this->schema_path(), 
    ...
    private:
            ...
            Json& patch) const final
        {
            ...
            if (if_validator_) 
            {
                ...
                if_validator_->validate(this_path, instance, instance_location, evaluated_properties, local_reporter, patch);
                if (local_reporter.errors.empty()) 
                {
                    if (then_validator_)
                        then_validator_->validate(this_path, instance, instance_location, evaluated_properties, reporter, patch);
                } 
                else 
                {
                    if (else_validator_)
                        else_validator_->validate(this_path, instance, instance_location, evaluated_properties, reporter, patch);
                }
            }
        }
    };
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            return jsoncons::make_unique<enum_validator>(this->schema_path(), Json(value_));
        }
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            return jsoncons::make_unique<const_validator>(this->schema_path(), Json(value_));
        }
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            return jsoncons::make_unique<type_validator>(this->schema_path(),
                std::vector<json_schema_type>(expected_types_));
        }
    ...
    public:
        ...
        std::unique_ptr<properties_validator<Json>> make_copy() const 
        {
            std::map<std::string, schema_validator_type> properties;

            for (const auto& item : properties_)
            {
                properties.emplace(item.first, item.second->make_copy());
            }

            return jsoncons::make_unique<properties_validator>(this->schema_path(),
                std::move(properties));
        }
            ...
            std::unordered_set<std::string>& all_properties) const 
        {
            ...
            jsonpointer::json_pointer this_path{eval_path};
            this_path.append(this->keyword_name());

            for (const auto& prop : instance.object_range()) 
            {
                jsonpointer::json_pointer prop_path{this_path};
                prop_path.append(prop.key());
                ...
                {
                    std::size_t error_count = reporter.error_count();
                    properties_it->second->validate(prop_path, prop.value() , pointer, evaluated_properties, reporter, patch);
    ...
    public:
        ...
        std::unique_ptr<pattern_properties_validator<Json>> make_copy() const 
        {
            std::vector<std::pair<std::regex, schema_validator_type>> pattern_properties;
            for (auto& item : pattern_properties_)
            {
                pattern_properties.emplace_back(item.first, item.second->make_copy());
            }

            return jsoncons::make_unique<pattern_properties_validator>(this->schema_path(),
            ...
            for (const auto& prop : instance.object_range()) 
            {
                ...
                for (auto& schema_pp : pattern_properties_)
                    if (std::regex_search(prop.key(), schema_pp.first)) 
                    {
                        all_properties.insert(prop.key());
                        std::size_t error_count = reporter.error_count();
                        schema_pp.second->validate(eval_path, prop.value() , pointer, evaluated_properties, reporter, patch);
                        if (reporter.error_count() == error_count)
                        {
                            evaluated_properties.insert(prop.key());
                        }
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            ...
            if (properties_)
            {
                properties = properties_->make_copy();
            }

            if (pattern_properties_)
            {
                pattern_properties = pattern_properties_->make_copy();
            }

            schema_validator_type additional_properties;
            if (additional_properties_)
            {
                additional_properties = additional_properties_->make_copy();
            }

            return jsoncons::make_unique<additional_properties_validator>(this->schema_path(),
                std::move(properties),
                std::move(pattern_properties),
    ...
    private:
            ...
            Json& patch) const final
        {
            ...
            if (properties_)
            {
                properties_->validate(this_path, instance, instance_location, evaluated_properties, reporter, patch, all_properties);
                if (reporter.fail_early())
                {
                    return;
                }
            ...
            if (pattern_properties_)
            {
                pattern_properties_->validate(this_path, instance, instance_location, evaluated_properties, reporter, patch, all_properties);
                if (reporter.fail_early())
                {
                    return;
                }
            ...
            for (const auto& prop : instance.object_range()) 
            {
                ...
                if (properties_it == all_properties.end()) 
                {
                    ...
                    if (additional_properties_) 
                    {
                        ...
                        additional_properties_->validate(this_path, prop.value() , pointer, evaluated_properties, local_reporter, patch);
                        if (!local_reporter.errors.empty())
                        {
                            reporter.error(validation_output(this->keyword_name(),
                                this_path, 
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            ...
            {
                dependent_required.emplace(item.first, item.second->make_copy());
            }

            return jsoncons::make_unique<dependent_required_validator>(this->schema_path(),
            ...
            Json& patch) const final
        {
            ...
            for (const auto& dep : dependent_required_) 
            {
                ...
                if (prop != instance.object_range().end()) 
                {
                    ...
                    jsonpointer::json_pointer pointer(instance_location);
                    pointer /= dep.first;
                    dep.second->validate(this_path, instance, pointer, evaluated_properties, reporter, patch); // validate
                }
            }
        }
    };
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            ...
            {
                dependent_schemas.emplace(item.first, item.second->make_copy());
            }

            return jsoncons::make_unique<dependent_schemas_validator>(this->schema_path(),
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            ...
            {
                property_names_schema_validator = property_names_schema_validator_->make_copy();
            }

            return jsoncons::make_unique<property_names_validator>(this->schema_path(),
    ...
    private:
            ...
            Json& patch) const final
        {
            ...
            for (const auto& prop : instance.object_range()) 
            {
                ...
                if (property_names_schema_validator_)
                {
                    property_names_schema_validator_->validate(this_path, prop.key() , instance_location, evaluated_properties, reporter, patch);
                }
                // Any property that doesn't match any of the property names in the properties keyword is ignored by this keyword.
            }
        }
    ...
    public:
        ...
        keyword_validator_type make_copy() const final 
        {
            ...
            return jsoncons::make_unique<dependencies_validator>(this->schema_path(),
                std::move(dependent_required),
                std::move(dependent_schemas));
        }
