...
#ifndef JSONCONS_JSONSCHEMA_SCHEMA_BUILDER_HPP
#define JSONCONS_JSONSCHEMA_SCHEMA_BUILDER_HPP
...
namespace jsonschema {
    ...
    public:
        ...
        schema_builder(const schema_builder&) = delete;
        schema_builder& operator=(const schema_builder&) = delete;
