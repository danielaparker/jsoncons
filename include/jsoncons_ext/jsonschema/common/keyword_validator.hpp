...
namespace jsonschema {
    ...
    public:
        ...
        virtual keyword_validator_type make_copy(const jsonpointer::json_pointer& eval_path) const = 0;
    };
    ...
    public:
        ...
        virtual schema_validator_type make_copy(const jsonpointer::json_pointer& eval_path) const = 0;
    };
