...
#ifndef JSONCONS_EXT_JSONSCHEMA_DRAFT6_VALIDATOR_FACTORY_6_HPP
#define JSONCONS_EXT_JSONSCHEMA_DRAFT6_VALIDATOR_FACTORY_6_HPP
...
namespace draft6 {
    ...
    class validator_factory_6 : public validator_factory<Json> 
    {
    public:
