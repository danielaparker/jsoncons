...
namespace draft7 {
    ...
    class schema_validator_factory_7 : public keyword_validator_factory<Json> 
    {
    public:
    ...
    public:
        schema_validator_factory_7(Json&& sch, const validator_factory_factory_type& factory_factory, 
            ...
            : keyword_validator_factory<Json>(schema_version::draft7(), std::move(sch), factory_factory, options, schema_store_ptr, resolve_funcs)
        {
            init();
        }
