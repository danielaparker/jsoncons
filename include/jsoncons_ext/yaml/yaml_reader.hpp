...
#ifndef JSONCONS_YAML_YAML_READER_HPP
#define JSONCONS_YAML_YAML_READER_HPP
...
namespace yaml {
    ...
    private:
        ...
        // Noncopyable and nonmoveable
        basic_yaml_reader(const basic_yaml_reader&) = delete;
        basic_yaml_reader& operator=(const basic_yaml_reader&) = delete;
    ...
    using yaml_reader = basic_yaml_reader<char>;
    using wyaml_reader = basic_yaml_reader<wchar_t>;
