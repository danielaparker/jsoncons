...
#ifndef JSONCONS_YAML_YAML_ENCODER_HPP
#define JSONCONS_YAML_YAML_ENCODER_HPP
...
namespace detail {
            ...
            switch (c)
            {
                ...
                default:
                    ...
                    else if (is_control_character(c) || escape_all_non_ascii)
                    {
                        ...
                        {
                            JSONCONS_THROW(ser_error(yaml_errc::illegal_codepoint));
                        }
    ...
    class basic_yaml_encoder final : public basic_json_visitor<CharT>
    {
    ...
    public:
        ...
        using string_type = typename basic_yaml_encode_options<CharT>::string_type;
    ...
    private:
        ...
        Sink sink_;
        basic_yaml_encode_options<CharT> options_;
        ...
        basic_yaml_encoder(const basic_yaml_encoder&) = delete;
        basic_yaml_encoder& operator=(const basic_yaml_encoder&) = delete;
    public:
        basic_yaml_encoder(Sink&& sink, 
                           const Allocator& alloc = Allocator())
            : basic_yaml_encoder(std::forward<Sink>(sink), basic_yaml_encode_options<CharT>(), alloc)
        {
        }
    ...
    template<class CharT,class Sink=jsoncons::stream_sink<CharT>,class Allocator=std::allocator<char>>
    class basic_compact_yaml_encoder final : public basic_json_visitor<CharT>
    {
        static const std::array<CharT, 4>& null_k()
        {
            static constexpr std::array<CharT,4> k{'n','u','l','l'};
    ...
    private:
        ...
        // Noncopyable
        basic_compact_yaml_encoder(const basic_compact_yaml_encoder&) = delete;
        basic_compact_yaml_encoder& operator=(const basic_compact_yaml_encoder&) = delete;
    public:
        basic_compact_yaml_encoder(Sink&& sink, 
                                      const Allocator& alloc = Allocator())
            : basic_compact_yaml_encoder(std::forward<Sink>(sink), basic_yaml_encode_options<CharT>(), alloc)
        {
        }
        ...
        basic_compact_yaml_encoder(basic_compact_yaml_encoder&&) = default;
        basic_compact_yaml_encoder& operator=(basic_compact_yaml_encoder&&) = default;

        ~basic_compact_yaml_encoder() noexcept
        {
            JSONCONS_TRY
            {
                sink_.flush();
    ...
    using json_stream_encoder = basic_yaml_encoder<char,jsoncons::stream_sink<char>>;
    using wjson_stream_encoder = basic_yaml_encoder<wchar_t,jsoncons::stream_sink<wchar_t>>;
    using compact_json_stream_encoder = basic_compact_yaml_encoder<char,jsoncons::stream_sink<char>>;
    using compact_wjson_stream_encoder = basic_compact_yaml_encoder<wchar_t,jsoncons::stream_sink<wchar_t>>;

    using json_string_encoder = basic_yaml_encoder<char,jsoncons::string_sink<std::string>>;
    using wjson_string_encoder = basic_yaml_encoder<wchar_t,jsoncons::string_sink<std::wstring>>;
    using compact_json_string_encoder = basic_compact_yaml_encoder<char,jsoncons::string_sink<std::string>>;
    using compact_wjson_string_encoder = basic_compact_yaml_encoder<wchar_t,jsoncons::string_sink<std::wstring>>;
