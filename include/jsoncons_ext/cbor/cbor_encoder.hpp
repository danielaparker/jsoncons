...
private:
    ...
    JSONCONS_VISITOR_RET_TYP visit_begin_object(std::size_t length, semantic_tag, const ser_context&, std::error_code& ec) override
    {
        if (JSONCONS_UNLIKELY(++nesting_depth_ > max_nesting_depth_))
        {
            ec = cbor_errc::max_nesting_depth_exceeded;
    ...
    JSONCONS_VISITOR_RET_TYP visit_begin_array(semantic_tag, const ser_context&, std::error_code& ec) override
    {
        if (JSONCONS_UNLIKELY(++nesting_depth_ > max_nesting_depth_))
        {
            ec = cbor_errc::max_nesting_depth_exceeded;
    ...
    JSONCONS_VISITOR_RET_TYP visit_begin_array(std::size_t length, semantic_tag, const ser_context&, std::error_code& ec) override
    {
        if (JSONCONS_UNLIKELY(++nesting_depth_ > max_nesting_depth_))
        {
            ec = cbor_errc::max_nesting_depth_exceeded;
    ...
    JSONCONS_VISITOR_RET_TYP visit_end_array(const ser_context&, std::error_code& ec) override
    {
        JSONCONS_ASSERT(!stack_.empty());
        --nesting_depth_;
    ...
    JSONCONS_VISITOR_RET_TYP visit_key(const string_view_type& name, const ser_context& context, std::error_code& ec) override
    {
    ...
    JSONCONS_VISITOR_RET_TYP visit_string(const string_view_type& sv, semantic_tag tag, const ser_context& context, std::error_code& ec) override
    {
        switch (tag)
        {
    ...
    JSONCONS_VISITOR_RET_TYP visit_double(double val, 
                      semantic_tag tag,
                      const ser_context&,
                      std::error_code&) override
    {
    ...
    JSONCONS_VISITOR_RET_TYP visit_bool(bool value, semantic_tag, const ser_context&, std::error_code&) override
    {
        if (value)
        {
            sink_.push_back(0xf5);
    ...
    JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const uint8_t>& v, 
        semantic_tag tag,
        const ser_context& context, 
        std::error_code& ec) override
    {
    ...
    JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const uint16_t>& data,  
        semantic_tag tag,
        const ser_context& context, 
        std::error_code& ec) override
    {
    ...
    JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const uint32_t>& data,  
        semantic_tag tag,
        const ser_context& context, 
        std::error_code& ec) override
    {
    ...
    JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const uint64_t>& data,  
        semantic_tag tag,
        const ser_context& context, 
        std::error_code& ec) override
    {
    ...
    JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const int8_t>& data,  
        semantic_tag,
        const ser_context& context, 
        std::error_code& ec) override
    {
    ...
    JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const int16_t>& data,  
        semantic_tag tag,
        const ser_context& context, 
        std::error_code& ec) override
    {
    ...
    JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const int32_t>& data,  
        semantic_tag tag,
        const ser_context& context, 
        std::error_code& ec) override
    {
    ...
    JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const int64_t>& data,  
        semantic_tag tag,
        const ser_context& context, 
        std::error_code& ec) override
    {
    ...
    JSONCONS_VISITOR_RET_TYP visit_typed_array(half_arg_t, const jsoncons::span<const uint16_t>& data,  
        semantic_tag tag,
        const ser_context& context, 
        std::error_code& ec) override
    {
    ...
    JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const float>& data,  
                        semantic_tag tag,
                        const ser_context& context, 
                        std::error_code& ec) override
    {
    ...
    JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const double>& data,  
        semantic_tag tag,
        const ser_context& context, 
        std::error_code& ec) override
    {
...
/*
    JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const float128_type>&, 
                        semantic_tag,
                        const ser_context&, 
                        std::error_code&) override
    {
