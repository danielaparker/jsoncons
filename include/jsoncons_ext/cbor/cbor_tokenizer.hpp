...
class basic_cbor_cursor : public ser_context
{
    ...
    {
        basic_cbor_cursor<Source,Allocator>* source;

        read_byte_string_from_source(basic_cbor_cursor<Source,Allocator>* source)
            : source(source)
        {
        }
        template <typename Container>
