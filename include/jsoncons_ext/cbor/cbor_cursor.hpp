...
class basic_cbor_cursor : public basic_staj_reader<CharT>, private virtual ser_context
{
public:
...
public:
    ...
    basic_cbor_cursor(Source&& source,
                      std::error_code& ec)
        : basic_cbor_cursor(std::forward<Source>(source),basic_json_options<CharT>::default_options(),default_err_handler_,ec)
    {
    }
