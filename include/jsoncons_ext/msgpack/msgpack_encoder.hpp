...
namespace msgpack {
    ...
    private:
        ...
        JSONCONS_VISITOR_RET_TYP visit_begin_object(std::size_t length, semantic_tag, const ser_context&, std::error_code& ec) final
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_end_object(const ser_context&, std::error_code& ec) final
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_begin_array(std::size_t length, semantic_tag, const ser_context&, std::error_code& ec) final
        {
            if (JSONCONS_UNLIKELY(++nesting_depth_ > max_nesting_depth_))
            {
                ec = msgpack_errc::max_nesting_depth_exceeded;
        ...
        JSONCONS_VISITOR_RET_TYP visit_end_array(const ser_context&, std::error_code& ec) final
        {
            JSONCONS_ASSERT(!stack_.empty());
        ...
        JSONCONS_VISITOR_RET_TYP visit_string(const string_view_type& sv, semantic_tag tag, const ser_context&, std::error_code& ec) final
        {
            switch (tag)
            {
        ...
        JSONCONS_VISITOR_RET_TYP visit_int64(int64_t val, 
            semantic_tag tag, 
            const ser_context&,
            std::error_code&) final
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_uint64(uint64_t val, 
            semantic_tag tag, 
            const ser_context&,
            std::error_code&) final
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_bool(bool val, semantic_tag, const ser_context&, std::error_code&) final
        {
            // true and false
