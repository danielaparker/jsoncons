...
private:
    ...
    basic_item_event_to_json_visitor_adaptor<char_type,Allocator> cursor_handler_adaptor_;
    bool eof_;
    ...
    {
        {
            ...
            {
                basic_item_event_to_json_visitor_adaptor<char_type,Allocator>& adaptor;
                basic_json_visitor<char_type>& original;

                resource_wrapper(basic_item_event_to_json_visitor_adaptor<char_type,Allocator>& adaptor,
