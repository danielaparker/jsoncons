...
class ubjson_decode_error : public std::invalid_argument, public virtual json_exception
{
public:
    explicit ubjson_decode_error(size_t pos) noexcept
        : std::invalid_argument("")
    {
        buffer_.append("Error decoding a message pack at position ");
        buffer_.append(std::to_string(pos));
    }
    ~ubjson_decode_error() noexcept
    {
    }
