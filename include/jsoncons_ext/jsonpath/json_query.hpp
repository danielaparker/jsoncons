...
namespace jsonpath {
    ...
    typename std::enable_if<ext_traits::is_function_object_2<Callback,const typename Json::string_type&,const Json&>::value,void>::type
    ...
    typename std::enable_if<ext_traits::is_function_object_2<BinaryCallback,const typename Json::string_type&,Json&>::value,void>::type
    ...
    typename std::enable_if<ext_traits::is_function_object_1<UnaryCallback,Json>::value,void>::type
