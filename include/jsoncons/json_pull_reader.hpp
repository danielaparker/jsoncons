...
public:
    ...
    basic_json_pull_reader(Source&& source, 
                           ...
                           std::function<bool(std::error_code,const ser_context&) noexcept> err_handler = default_parse_error_handler())
...
using basic_json_cursor = basic_json_pull_reader<CharT,Src,Allocator>;

JSONCONS_DEPRECATED("Instead, use json_pull_reader") typedef json_pull_reader json_cursor;
JSONCONS_DEPRECATED("Instead, use wjson_pull_reader") typedef wjson_pull_reader wjson_cursor;
