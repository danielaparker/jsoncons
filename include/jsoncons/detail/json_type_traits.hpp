...
#ifndef JSONCONS_DETAIL_JSON_TYPE_TRAITS_HPP
#define JSONCONS_DETAIL_JSON_TYPE_TRAITS_HPP
...
template <class Traits, class Json, class T, class Enable=void>
...
// is_incompatible
template<class Traits, class Json, class T>
struct is_incompatible<Traits, Json,T,
    typename std::enable_if<!std::integral_constant<bool, typename Traits::base_traits<Json, T>::is_compatible>::value>::type
> : std::true_type {};
...
template<class Traits, class Json, class T>
struct is_compatible_string_type<Traits,Json,T, 
    typename std::enable_if<!std::is_same<T,typename Json::array>::value &&
    detail::is_string_like<T>::value && 
    !is_incompatible<Traits,Json,typename std::iterator_traits<typename T::iterator>::value_type>::value
>::type> : std::true_type {};
...
template<class Traits, class Json, class T>
struct is_compatible_array_type<Traits,Json,T, 
    typename std::enable_if<!std::is_same<T,typename Json::array>::value &&
...
template<class Traits, class Json, class T>
struct is_compatible_object_type<Traits,Json,T, 
                       typename std::enable_if<
    !is_incompatible<Traits, Json,typename T::mapped_type>::value
>::type> : std::true_type {};
...
public:
    ...
    {
        return typename Traits::base_traits<Json, T>::as(*it_);
    }
...
public:
    ...
    reference operator*() const
    {
        return T(key_type(it_->key()),typename Traits::base_traits<Json,mapped_type>::as(it_->value()));
    }
...
template<class Traits, class Json>
struct json_type_traits<Traits, Json, typename type_wrapper<typename Json::char_type>::const_pointer_type>
{
...
template<class Traits, class Json>
struct json_type_traits<Traits, Json, typename type_wrapper<typename Json::char_type>::pointer_type>
{
    typedef typename Json::char_type char_type;
    typedef typename Json::allocator_type allocator_type;
...
template<class Traits, class Json, class T>
struct json_type_traits<Traits, Json, T,
...
template<class Traits, class Json>
struct json_type_traits<Traits, Json, typename Json::object>
{
    typedef typename Json::allocator_type allocator_type;
...
template<class Traits, class Json>
struct json_type_traits<Traits, Json, typename Json::array>
{
    typedef typename Json::allocator_type allocator_type;
...
template<class Traits, class Json>
struct json_type_traits<Traits, Json, Json>
{
    typedef typename Json::allocator_type allocator_type;
...
template<class Traits, class Json>
struct json_type_traits<Traits, Json, jsoncons::null_type>
{
    typedef typename Json::allocator_type allocator_type;
...
template<class Traits, class Json>
struct json_type_traits<Traits, Json, bool>
{
    typedef typename Json::allocator_type allocator_type;
...
template<class Traits,class Json,class T>
struct json_type_traits<Traits, Json, T, typename std::enable_if<std::is_same<T, 
...
template<class Traits, class Json>
struct json_type_traits<Traits, Json, std::vector<bool>::reference>
{
    typedef typename Json::allocator_type allocator_type;
...
template<class Traits, class Json, typename T>
struct json_type_traits<Traits, Json, T, 
                        typename std::enable_if<detail::is_compatible_array_type<Traits,Json,T>::value && 
                                                !detail::is_std_array<T>::value>::type>
{
    ...
    as(const Json& j)
    {
        if (j.is_array())
        {
            T v(detail::json_array_input_iterator<Traits, Json, element_type>(j.array_range().begin()),
                detail::json_array_input_iterator<Traits, Json, element_type>(j.array_range().end()));
            return v;
        }
        else
        {
...
template<class Traits, class Json, typename T>
struct json_type_traits<Traits, Json, T, 
                        typename std::enable_if<detail::is_compatible_string_type<Traits,Json,T>::value>::type>
{
    typedef typename std::iterator_traits<typename T::iterator>::value_type element_type;
    typedef typename Json::allocator_type allocator_type;
...
template<class Traits, class Json, typename T>
struct json_type_traits<Traits, Json, T, 
                        typename std::enable_if<detail::is_compatible_object_type<Traits,Json,T>::value>::type
>
{
    ...
    static T as(const Json& j)
    {
        T v(detail::json_object_input_iterator<Traits,Json,value_type>(j.object_range().begin()),
            detail::json_object_input_iterator<Traits,Json,value_type>(j.object_range().end()));
        return v;
    }
...
template<class Traits, class Json, class E, size_t N>
struct json_type_traits<Traits, Json, std::array<E, N>>
{
    typedef typename Json::allocator_type allocator_type;
...
struct json_tuple_helper
{
    ...
    {
        jsons[Pos - 1] = typename Traits::base_traits<Json, element_type>::to_json(std::get<Pos-1>(tuple));
        next::to_json(tuple, jsons);
    }
};

template<class Traits, class Json, class Tuple>
...
template<class Traits, class Json, typename... E>
struct json_type_traits<Traits, Json, std::tuple<E...>>
{
private:
...
template<class Traits, class Json, class T1, class T2>
struct json_type_traits<Traits, Json, std::pair<T1,T2>>
{
public:
    static bool is(const Json& j) JSONCONS_NOEXCEPT
    {
...
template<class Traits, class Json, class Allocator>
struct json_type_traits<Traits, Json, basic_byte_string<Allocator>>
{
public:
    static bool is(const Json& j) JSONCONS_NOEXCEPT
    {
...
template<class Traits, class Json, class T>
struct json_type_traits<Traits, Json, std::valarray<T>>
{
    typedef typename Json::allocator_type allocator_type;
