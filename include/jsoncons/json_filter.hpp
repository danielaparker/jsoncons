...
private:
    ...
    JSONCONS_VISITOR_RET_TYP visit_begin_object(semantic_tag tag, 
        const ser_context& context,
        std::error_code& ec) override
    {
        destination1_->begin_object(tag, context, ec);
    ...
    JSONCONS_VISITOR_RET_TYP visit_begin_object(std::size_t length, 
        semantic_tag tag, 
        const ser_context& context,
        std::error_code& ec) override
    {
    ...
    JSONCONS_VISITOR_RET_TYP visit_begin_array(semantic_tag tag, 
                        const ser_context& context,
                        std::error_code& ec) override
    {
        destination1_->begin_array(tag, context, ec);
    ...
    JSONCONS_VISITOR_RET_TYP visit_begin_array(std::size_t length, 
                        semantic_tag tag, 
                        const ser_context& context,
                        std::error_code& ec) override
    {
...
private:
    ...
    JSONCONS_VISITOR_RET_TYP visit_key(const string_view_type& key,
        const ser_context& context,
        std::error_code& ec) override
    {
