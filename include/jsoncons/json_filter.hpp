...
template <class From,class To,typename std::enable_if<jsoncons::detail::is_narrow_character<typename From::char_type>::value &&
                                                      jsoncons::detail::is_narrow_character<typename To::char_type>::value>::type>
class json_visitor_adaptor : public json_visitor_adaptor_base<From,To>
{
