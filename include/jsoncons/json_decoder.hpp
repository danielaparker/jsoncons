...
private:
    ...
    bool do_begin_object(semantic_tag_type tag, const serializing_context&, std::error_code&) override
    {
    ...
    bool do_begin_array(semantic_tag_type tag, const serializing_context&, std::error_code&) override
    {
        switch (stack_offsets_.back().type_)
        {
            case structure_type::object_t:
    ...
    bool do_byte_string_value(const byte_string_view& b, byte_string_chars_format encoding_hint, semantic_tag_type tag, const serializing_context&, std::error_code&) override
    {
        switch (stack_offsets_.back().type_)
        {
            case structure_type::object_t:
    ...
    bool do_bool_value(bool value, semantic_tag_type tag, const serializing_context&, std::error_code&) override
    {
        switch (stack_offsets_.back().type_)
        {
            case structure_type::object_t:
