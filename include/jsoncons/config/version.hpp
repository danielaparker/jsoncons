...
#define JSONCONS_VERSION_STRING JSONCONS_PP_STRINGIFY(JSONCONS_VERSION_MAJOR) "." JSONCONS_PP_STRINGIFY(JSONCONS_VERSION_MINOR) "." JSONCONS_PP_STRINGIFY(JSONCONS_VERSION_PATCH)
