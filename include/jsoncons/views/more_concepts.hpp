...
template <typename T>
concept string_or_string_view = ext_traits::is_string_or_string_view_v<T>;    

template <typename T, typename CharT>
concept string_or_string_view_of = ext_traits::is_string_or_string_view_v<T> && std::is_same_v<CharT,char>;    

template <typename T>
concept string = ext_traits::is_string_v<T>;    
