...
namespace jsoncons2 {
    ...
    private:
        using element_allocator_type = typename std::allocator_traits<allocator_type>:: template rebind_alloc<json_element>;
        json_element* root_;
    ...
    public:
        ...
        json_document(json_element* root, std::size_t root_capacity,
        ...
        json_document(const json_document& other) = delete;
        ...
        json_document& operator=(const json_document& other) = delete;
        ...
        static deserialize_result<json_document> parse(std::string_view sv, read_json_flags flg = read_json_flags::none)
        {
        ...
        static deserialize_result<json_document> parse_file(std::string_view sv, read_json_flags flg = read_json_flags::none)
        {
            allocator_type alloc{};
            element_allocator_type element_alloc{};
            flg &= ~read_json_flags::insitu; /* const string cannot be modified */
    ...
    private:
        static deserialize_result<json_document> parse(char* dat, size_t len, read_json_flags flg,
            allocator_type& alloc, element_allocator_type& element_alloc);

        static deserialize_result<json_document> yyjson_read_opts(char* dat,
            std::size_t len,
            read_json_flags flg,
            allocator_type& alloc, element_allocator_type& element_alloc);

        static deserialize_result<json_document> yyjson_read_file(const char* path,
            read_json_flags flg,
            allocator_type& alloc, element_allocator_type& element_alloc);

        static deserialize_result<json_document> yyjson_read_fp(FILE* file,
            read_json_flags flg,
            allocator_type& alloc, element_allocator_type& element_alloc);
        
        static deserialize_result<json_document> read_root_single(uint8_t *hdr,
        ...
        static deserialize_result<json_document> read_root_minify(uint8_t *hdr,
            std::size_t hdr_capacity,
            uint8_t *cur,
            uint8_t *end,
            read_json_flags flags,
        ...
        static deserialize_result<json_document> read_root_pretty(uint8_t *hdr,
            std::size_t hdr_capacity,
            uint8_t *cur,
            uint8_t *end,
            read_json_flags flags,
