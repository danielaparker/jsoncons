...
namespace jsoncons {
    ...
    private:
...
#if !defined(JSONCONS_NO_DEPRECATED)
        JSONCONS_DEPRECATED_MSG("Instead, use do_null") 
        ...
        JSONCONS_DEPRECATED_MSG("Instead, use do_bool") 
        ...
        JSONCONS_DEPRECATED_MSG("Instead, use do_string") 
        ...
        JSONCONS_DEPRECATED_MSG("Instead, use do_byte_string") 
        virtual bool do_byte_string_value(const byte_string_view& value, 
                                          semantic_tag tag, 
                                          const ser_context& context,
                                          std::error_code& ec)
        {
            return do_byte_string(value, tag, context, ec);
        }


        JSONCONS_DEPRECATED_MSG("Instead, use do_uint64") 
        ...
        JSONCONS_DEPRECATED_MSG("Instead, use do_int64") 
        ...
        JSONCONS_DEPRECATED_MSG("Instead, use do_half") 
        ...
        JSONCONS_DEPRECATED_MSG("Instead, use do_double") 
