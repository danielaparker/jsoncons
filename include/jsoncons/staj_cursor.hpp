...
private:
    ...
    JSONCONS_VISITOR_RETURN_TYPE visit_begin_object(std::size_t length, semantic_tag tag, const ser_context&, std::error_code&) final
    {
        ...
        if (structure.is_key)
        {
            event_ = staj_event_type(staj_events::begin_object, length, tag, staj_events::kflag);
        }
        else 
        {
    ...
    JSONCONS_VISITOR_RETURN_TYPE visit_begin_object(semantic_tag tag, const ser_context&, std::error_code&) final
    {
        ...
        if (structure.is_key)
        {
            event_ = staj_event_type(staj_events::begin_object, tag, staj_events::kflag);
        }
        else 
        {
    ...
    JSONCONS_VISITOR_RETURN_TYPE visit_end_object(const ser_context&, std::error_code&) final
    {
        ...
        {
            event_ = staj_event_type(staj_events::end_object, semantic_tag::none, staj_events::kflag);
        }
        else 
        {
    ...
    JSONCONS_VISITOR_RETURN_TYPE visit_begin_array(semantic_tag tag, const ser_context&, std::error_code&) final
    {
        ...
        if (structure.is_key)
        {
            event_ = staj_event_type(staj_events::begin_array, tag, staj_events::kflag);
        }
        else
        {
        ...
        semantic_tag tag, const ser_context&, std::error_code&) final
    {
        ...
        if (structure.is_key)
        {
            event_ = staj_event_type(staj_events::begin_array, length, tag, staj_events::kflag);
        }
        else
        {
    ...
    JSONCONS_VISITOR_RETURN_TYPE visit_end_array(const ser_context&, std::error_code&) final
    {
        ...
        if (structure_stack_.back().is_key)
        {
            event_ = staj_event_type(staj_events::end_array, semantic_tag::none, staj_events::kflag);
        }
        else
        {
    ...
    JSONCONS_VISITOR_RETURN_TYPE visit_string(const string_view_type& sv, semantic_tag tag, const ser_context&, std::error_code&) final
    {
        ...
        if (structure.is_key)
        {
            event_ = staj_event_type(sv, staj_events::string_value, tag, staj_events::kflag);
        }
        else
        {
        ...
        std::error_code&) final
    {
        ...
        if (structure.is_key)
        {
            event_ = staj_event_type(value, staj_events::byte_string_value, tag, staj_events::kflag);
        }
        else
        {
        ...
        std::error_code&) final
    {
        ...
        if (structure.is_key)
        {
            event_ = staj_event_type(value, staj_events::byte_string_value, raw_tag, staj_events::kflag);
        }
        else
        {
        ...
        std::error_code&) final
    {
        ...
        if (structure.is_key)
        {
            event_ = staj_event_type(value, tag, staj_events::kflag);
        }
        else
        {
        ...
        std::error_code&) final
    {
        ...
        if (structure.is_key)
        {
            event_ = staj_event_type(half_arg, value, tag, staj_events::kflag);
        }
        else
        {
    ...
    JSONCONS_VISITOR_RETURN_TYPE visit_null(semantic_tag tag, const ser_context&, std::error_code&) final
    {
        ...
        if (structure.is_key)
        {
            event_ = staj_event_type(staj_events::null_value, tag, staj_events::kflag);
        }
        else
        {
