...
typename std::enable_if<!nonstd::is_std_pair<T>::value && std::uses_allocator<T, Alloc>::value
...
typename std::enable_if<nonstd::is_std_pair<T>::value, T>::type
make_obj_using_allocator(const Alloc& alloc)
{
    return T(
        jsoncons::nonstd::make_obj_using_allocator<typename T::first_type>(alloc), 
        jsoncons::nonstd::make_obj_using_allocator<typename T::second_type>(alloc));
}
...
{
    return T(
        jsoncons::nonstd::make_obj_using_allocator<typename T::first_type>(alloc,std::forward<U>(u)), 
        jsoncons::nonstd::make_obj_using_allocator<typename T::second_type>(alloc,std::forward<V>(v)));
}
...
{
    return T(
        jsoncons::nonstd::make_obj_using_allocator<typename T::first_type>(alloc,pr.first), 
        jsoncons::nonstd::make_obj_using_allocator<typename T::second_type>(alloc,pr.second));
}
...
{
    return T(
        jsoncons::nonstd::make_obj_using_allocator<typename T::first_type>(alloc,std::move(pr.first)), 
        jsoncons::nonstd::make_obj_using_allocator<typename T::second_type>(alloc,std::move(pr.second)));
}
