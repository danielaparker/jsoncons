...
template<class CharT,class Src=jsoncons::stream_source<CharT>,class TempAllocator=std::allocator<char>>
...
public:
    ...
    explicit basic_json_reader(Source&& source, const TempAllocator& alloc = TempAllocator())
