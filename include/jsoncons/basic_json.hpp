...
private:
    ...
    public:
       ...
       // emplace
        ...
        JSONCONS_DEPRECATED_MSG("Instead, use tag() == semantic_tag::epoch_seconds")
        bool is_epoch_seconds() const noexcept
        {
            if (!parent_.contains(key_))
            {
                return false;
            }
            return evaluate().is_epoch_seconds();
        }
...
public:
    ...
    bool is_epoch_seconds() const noexcept
    {
        return tag() == semantic_tag::epoch_seconds;
    }
