    ...
    private:
        struct json_const_pointer_storage 
        {
            ...
            json_const_pointer_storage(const basic_json* p)
                : storage_kind_(static_cast<uint8_t>(json_storage_kind::json_const_pointer)), short_str_length_(0), tag_(p->tag()),
                  p_(p)
            {
            }
        ...
        struct json_pointer_storage 
        {
            ...
            json_pointer_storage(basic_json* p)
                : storage_kind_(static_cast<uint8_t>(json_storage_kind::json_pointer)), short_str_length_(0), tag_(p->tag()),
                  p_(p)
            {
            }
        ...
        union 
        {
            ...
            json_pointer_storage json_pointer_;
        };
    ...
    private:
        ...
        void swap_l(basic_json& other) noexcept
        {
            switch (other.storage_kind())
            {
                ...
                case json_storage_kind::json_pointer : swap_l_r<TypeL, json_pointer_storage>(other); break;
                default:
    ...
    public:
        ...
        json_type type() const
        {
            switch(storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->type();
                default:
                    JSONCONS_UNREACHABLE();
                    break;
            }
        ...
        semantic_tag tag() const
        {
            ...
            switch(storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->tag();
                default:
                    return common_.tag_;
            }
        }
        ...
        std::size_t size() const
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->size();
                default:
                    return 0;
            }
        }
        ...
        string_view_type as_string_view() const
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->as_string_view();
                default:
        ...
        basic_byte_string<BAllocator> as_byte_string() const
        {
            ...
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->as_byte_string();
                default:
        ...
        byte_string_view as_byte_string_view() const
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->as_byte_string_view();
                default:
                    JSONCONS_THROW(json_runtime_error<std::domain_error>("Not a byte string"));
            }
        }
        ...
        int compare(const basic_json& rhs) const noexcept
        {
            ...
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    ...
                    {
                        case json_storage_kind::json_pointer:
                            return (cast<json_pointer_storage>().value())->compare(*(rhs.cast<json_pointer_storage>().value()));
                        default:
                            return (cast<json_pointer_storage>().value())->compare(rhs);
                    }
                    break;
                case json_storage_kind::null:
                ...
                case json_storage_kind::empty_object:
                    switch (rhs.storage_kind())
                    {
                        ...
                        case json_storage_kind::json_pointer:
                            return compare(*(rhs.cast<json_pointer_storage>().value()));
                        default:
                            return static_cast<int>(storage_kind()) - static_cast<int>((int)rhs.storage_kind());
                    }
                    break;
        ...
        void swap(basic_json& other) noexcept
        {
            ...
            else
            {
                switch (storage_kind())
                {
                    ...
                    case json_storage_kind::json_pointer: swap_l<json_pointer_storage>(other); break;
                    default:
                        JSONCONS_UNREACHABLE();
                        break;
                }
        ...
        basic_json(json_pointer_arg_t, basic_json* p) noexcept 
        {
            if (p == nullptr)
            {
                construct<null_storage>(semantic_tag::none);
            ...
            {
                construct<json_pointer_storage>(p);
            }
        }
    ...
    // end legacy
        ...
        bool is_null() const noexcept
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->is_null();
                default:
                    return false;
            }
        }
        ...
        uint64_t ext_tag() const
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->ext_tag();
                default:
                    return 0;
            }
        }
        ...
        bool contains(const string_view_type& key) const noexcept
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->contains(key);
                default:
                    return false;
            }
        }
        ...
        std::size_t count(const string_view_type& key) const
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->count(key);
                default:
                    return 0;
            }
        }
        ...
        bool is_string() const noexcept
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->is_string();
                default:
                    return false;
            }
        }
        ...
        bool is_byte_string() const noexcept
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->is_byte_string();
                default:
                    return false;
            }
        }
        ...
        bool is_bignum() const
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::uint64:
                    return true;
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->is_bignum();
                default:
                    return false;
            }
        }
        ...
        bool is_bool() const noexcept
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->is_bool();
                default:
                    return false;
            }
        }
        ...
        bool is_object() const noexcept
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->is_object();
                default:
                    return false;
            }
        }
        ...
        bool is_array() const noexcept
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->is_array();
                default:
                    return false;
            }
        }
        ...
        bool is_int64() const noexcept
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->is_int64();
                default:
                    return false;
            }
        }
        ...
        bool is_uint64() const noexcept
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->is_uint64();
                default:
                    return false;
            }
        }
        ...
        bool is_half() const noexcept
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->is_half();
                default:
                    return false;
            }
        }
        ...
        bool is_double() const noexcept
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->is_double();
                default:
                    return false;
            }
        }
        ...
        bool is_number() const noexcept
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->is_number();
                default:
                    return false;
            }
        }
        ...
        bool empty() const noexcept
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->empty();
                default:
                    return false;
            }
        }
        ...
        std::size_t capacity() const
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->capacity();
                default:
                    return 0;
            }
        }
        ...
        as(byte_string_arg_t, semantic_tag hint) const
        {
            ...
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->template as<T>(byte_string_arg, hint);
                default:
                    JSONCONS_THROW(json_runtime_error<std::domain_error>("Not a byte string"));
            }
        }
        ...
        bool as_bool() const 
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->as_bool();
                default:
        ...
        IntegerType as_integer() const
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->template as_integer<IntegerType>();
                default:
        ...
        is_integer() const noexcept
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->template is_integer<IntegerType>();
                default:
                    return false;
            }
        }
        ...
        double as_double() const
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->as_double();
                default:
        ...
        std::basic_string<char_type,char_traits_type,SAllocator> as_string(const SAllocator& alloc) const 
        {
            ...
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->as_string(alloc);
                default:
                {
                    string_type2 s(alloc);
                    basic_compact_json_encoder<char_type,jsoncons::string_sink<string_type2>> encoder(s);
        ...
        const char_type* as_cstring() const
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->as_cstring();
                default:
        ...
        basic_json& at(const string_view_type& key)
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->at(key);
                default:
                {
                    JSONCONS_THROW(not_an_object(key.data(),key.length()));
                }
        ...
        basic_json& at(std::size_t i)
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->at(i);
                default:
        ...
        const_object_iterator find(const string_view_type& key) const
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->find(key);
                default:
                {
                    JSONCONS_THROW(not_an_object(key.data(),key.length()));
                }
        ...
        const basic_json& at_or_null(const string_view_type& key) const
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->at_or_null(key);
                default:
                {
                    JSONCONS_THROW(not_an_object(key.data(),key.length()));
                }
        ...
        T get_value_or(const string_view_type& key, U&& default_value) const
        {
            ...
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->template get_value_or<T,U>(key,std::forward<U>(default_value));
                default:
                {
                    JSONCONS_THROW(not_an_object(key.data(),key.length()));
                }
        ...
        void shrink_to_fit()
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::object:
                    ...
                    break;
                case json_storage_kind::json_pointer:
                    cast<json_pointer_storage>().value()->shrink_to_fit();
                    break;
                default:
                    break;
            }
        ...
        void clear()
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::object:
                    ...
                    break;
                case json_storage_kind::json_pointer:
                    cast<json_pointer_storage>().value()->clear();
                    break;
                default:
                    break;
            }
        ...
        object_iterator erase(const_object_iterator pos)
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->erase(pos);
            default:
        ...
        object_iterator erase(const_object_iterator first, const_object_iterator last)
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->erase(first, last);
                default:
                    JSONCONS_THROW(json_runtime_error<std::domain_error>("Not an object"));
                    break;
            }
        ...
        void erase(const string_view_type& key)
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::object:
                    ...
                    break;
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->erase(key);
                default:
                    JSONCONS_THROW(not_an_object(key.data(),key.length()));
                    break;
            }
        ...
        std::pair<object_iterator,bool> insert_or_assign(const string_view_type& key, T&& val)
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->insert_or_assign(key, std::forward<T>(val));
                default:
                    JSONCONS_THROW(not_an_object(key.data(),key.length()));
            }
        }
        ...
        std::pair<object_iterator,bool> try_emplace(const string_view_type& key, Args&&... args)
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->try_emplace(key, std::forward<Args>(args)...);
                default:
                    JSONCONS_THROW(not_an_object(key.data(),key.length()));
            }
        }
                ...
                case json_storage_kind::object:
                    switch (storage_kind())
                    {
                        ...
                        case json_storage_kind::object:
                            ...
                            break;
                        case json_storage_kind::json_pointer:
                            cast<json_pointer_storage>().value()->merge(source.cast<object_storage>().value());
                            break;
                        default:
        ...
        array_iterator emplace(const_array_iterator pos, Args&&... args)
        {
            switch (storage_kind())
            {
                case json_storage_kind::array:
                    ...
                    break;
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->emplace(pos, std::forward<Args>(args)...);
                default:
                    JSONCONS_THROW(json_runtime_error<std::domain_error>("Attempting to insert into a value that is not an array"));
            }
        }
        ...
        basic_json& emplace_back(Args&&... args)
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->emplace_back(std::forward<Args>(args)...);
                default:
                    JSONCONS_THROW(json_runtime_error<std::domain_error>("Attempting to insert into a value that is not an array"));
            }
        }
        ...
        void push_back(T&& val)
        {
            switch (storage_kind())
            {
                case json_storage_kind::array:
                    ...
                    break;
                case json_storage_kind::json_pointer:
                    cast<json_pointer_storage>().value()->push_back(std::forward<T>(val));
                    break;
                default:
                    JSONCONS_THROW(json_runtime_error<std::domain_error>("Attempting to insert into a value that is not an array"));
            }
        ...
        void push_back(basic_json&& val)
        {
            switch (storage_kind())
            {
                case json_storage_kind::array:
                    ...
                    break;
                case json_storage_kind::json_pointer:
                    cast<json_pointer_storage>().value()->push_back(std::move(val));
                    break;
                default:
                    JSONCONS_THROW(json_runtime_error<std::domain_error>("Attempting to insert into a value that is not an array"));
            }
        ...
        object_range_type object_range()
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->object_range();
                default:
                    JSONCONS_THROW(json_runtime_error<std::domain_error>("Not an object"));
            }
        }
        ...
        array_range_type array_range()
        {
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->array_range();
                default:
                    JSONCONS_THROW(json_runtime_error<std::domain_error>("Not an array"));
            }
        }
    ...
    private:
        ...
        void dump_noflush(basic_json_visitor<char_type>& visitor, std::error_code& ec) const
        {
            ...
            switch (storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return cast<json_pointer_storage>().value()->dump_noflush(visitor, ec);
                default:
                    break;
            }
        }
        ...
        friend basic_json deep_copy(const basic_json& other)
        {
            switch (other.storage_kind())
            {
                ...
                case json_storage_kind::json_pointer:
                    return deep_copy(*(other.cast<json_pointer_storage>().value()));
                default:
                    return other;
            }
        }
