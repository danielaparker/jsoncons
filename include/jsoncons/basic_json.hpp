...
public:
    ...
    JSONCONS_DEPRECATED_MSG("instead, use basic_json<char_type,implementation_policy,allocator_type>") typedef basic_json value_type;
    JSONCONS_DEPRECATED_MSG("instead, use basic_json<char_type,implementation_policy,allocator_type>") typedef basic_json json_type;
    JSONCONS_DEPRECATED_MSG("instead, use basic_string<char_type>") typedef std::basic_string<char_type> string_type;
    ...
    JSONCONS_DEPRECATED_MSG("Instead, use basic_json(double,semantic_tag)")
