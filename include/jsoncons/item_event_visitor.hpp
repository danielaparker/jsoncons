...
namespace jsoncons { 
    ...
    public:
        ...
        JSONCONS_VISITOR_RET_TYP begin_object(semantic_tag tag=semantic_tag::none,
        ...
        JSONCONS_VISITOR_RET_TYP begin_object(std::size_t length, 
        ...
        JSONCONS_VISITOR_RET_TYP end_object(const ser_context& context = ser_context())
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP begin_array(semantic_tag tag=semantic_tag::none,
            const ser_context& context=ser_context())
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP begin_array(std::size_t length, 
            semantic_tag tag=semantic_tag::none,
            const ser_context& context=ser_context())
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP end_array(const ser_context& context=ser_context())
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP key(const string_view_type& name, const ser_context& context=ser_context())
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP null_value(semantic_tag tag = semantic_tag::none,
            const ser_context& context=ser_context()) 
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP bool_value(bool value, 
            semantic_tag tag = semantic_tag::none,
            const ser_context& context=ser_context()) 
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP string_value(const string_view_type& value, 
            semantic_tag tag = semantic_tag::none, 
            const ser_context& context=ser_context()) 
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP byte_string_value(const BytesViewLike& b, 
            semantic_tag tag=semantic_tag::none, 
            const ser_context& context=ser_context(),
        ...
        JSONCONS_VISITOR_RET_TYP uint64_value(uint64_t value, 
            semantic_tag tag = semantic_tag::none, 
            const ser_context& context=ser_context())
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP int64_value(int64_t value, 
            semantic_tag tag = semantic_tag::none, 
            const ser_context& context=ser_context())
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP half_value(uint16_t value, 
            semantic_tag tag = semantic_tag::none, 
            const ser_context& context=ser_context())
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP double_value(double value, 
            semantic_tag tag = semantic_tag::none, 
            const ser_context& context=ser_context())
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP begin_object(semantic_tag tag,
        ...
        JSONCONS_VISITOR_RET_TYP end_object(const ser_context& context, std::error_code& ec)
        {
            visit_end_object(context, ec);
            JSONCONS_VISITOR_RET_VAL
        }

        JSONCONS_VISITOR_RET_TYP begin_array(semantic_tag tag, const ser_context& context, std::error_code& ec)
        {
            visit_begin_array(tag, context, ec);
            JSONCONS_VISITOR_RET_VAL
        }

        JSONCONS_VISITOR_RET_TYP begin_array(std::size_t length, semantic_tag tag, const ser_context& context, std::error_code& ec)
        {
            visit_begin_array(length, tag, context, ec);
            JSONCONS_VISITOR_RET_VAL
        }

        JSONCONS_VISITOR_RET_TYP end_array(const ser_context& context, std::error_code& ec)
        {
            visit_end_array(context, ec);
            JSONCONS_VISITOR_RET_VAL
        }

        JSONCONS_VISITOR_RET_TYP key(const string_view_type& name, const ser_context& context, std::error_code& ec)
        {
            visit_string(name, semantic_tag::none, context, ec);
            JSONCONS_VISITOR_RET_VAL
        }

        JSONCONS_VISITOR_RET_TYP null_value(semantic_tag tag,
            const ser_context& context,
            std::error_code& ec) 
        {
            visit_null(tag, context, ec);
        ...
        JSONCONS_VISITOR_RET_TYP byte_string_value(const Source& b, 
            semantic_tag tag, 
            const ser_context& context,
            std::error_code& ec,
        ...
        template <typename T>
        JSONCONS_VISITOR_RET_TYP typed_array(const jsoncons::span<T>& data, 
            semantic_tag tag=semantic_tag::none,
            const ser_context& context=ser_context())
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP typed_array(half_arg_t, const jsoncons::span<const uint16_t>& s,
            semantic_tag tag = semantic_tag::none,
            const ser_context& context = ser_context())
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP begin_multi_dim(const jsoncons::span<const size_t>& shape,
        ...
        JSONCONS_VISITOR_RET_TYP end_multi_dim(const ser_context& context=ser_context()) 
        {
            std::error_code ec;
        ...
        JSONCONS_VISITOR_RET_TYP end_multi_dim(const ser_context& context,
                           std::error_code& ec) 
        {
            visit_end_multi_dim(context, ec);
            JSONCONS_VISITOR_RET_VAL
    ...
    private:
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_begin_object(semantic_tag tag, 
            const ser_context& context, 
            std::error_code& ec) = 0;

        virtual JSONCONS_VISITOR_RET_TYP visit_begin_object(std::size_t /*length*/, 
            semantic_tag tag, 
            const ser_context& context, 
            std::error_code& ec)
        {
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_end_object(const ser_context& context, 
            std::error_code& ec) = 0;

        virtual JSONCONS_VISITOR_RET_TYP visit_begin_array(semantic_tag tag, 
            const ser_context& context, 
            std::error_code& ec) = 0;

        virtual JSONCONS_VISITOR_RET_TYP visit_begin_array(std::size_t /*length*/, 
            semantic_tag tag, 
            const ser_context& context, 
            std::error_code& ec)
        {
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_end_array(const ser_context& context, 
            std::error_code& ec) = 0;

        virtual JSONCONS_VISITOR_RET_TYP visit_null(semantic_tag tag, 
            const ser_context& context, 
            std::error_code& ec) = 0;

        virtual JSONCONS_VISITOR_RET_TYP visit_bool(bool value, 
            semantic_tag tag, 
            const ser_context& context, 
            std::error_code&) = 0;

        virtual JSONCONS_VISITOR_RET_TYP visit_string(const string_view_type& value, 
            semantic_tag tag, 
            const ser_context& context, 
            std::error_code& ec) = 0;

        virtual JSONCONS_VISITOR_RET_TYP visit_byte_string(const byte_string_view& value, 
            semantic_tag tag, 
            const ser_context& context,
            std::error_code& ec) = 0;
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_uint64(uint64_t value, 
            semantic_tag tag, 
            const ser_context& context,
            std::error_code& ec) = 0;

        virtual JSONCONS_VISITOR_RET_TYP visit_int64(int64_t value, 
            semantic_tag tag,
            const ser_context& context,
            std::error_code& ec) = 0;

        virtual JSONCONS_VISITOR_RET_TYP visit_half(uint16_t value, 
            semantic_tag tag,
            const ser_context& context,
            std::error_code& ec)
        {
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_double(double value, 
            semantic_tag tag,
            const ser_context& context,
            std::error_code& ec) = 0;

        virtual JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const uint8_t>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec)  
        {
            begin_array(s.size(), tag, context, ec);
            if (JSONCONS_UNLIKELY(ec)) {JSONCONS_VISITOR_RET_VAL}
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const uint16_t>& s, 
            semantic_tag tag, 
            const ser_context& context, 
            std::error_code& ec)  
        {
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const uint32_t>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec) 
        {
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const uint64_t>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec) 
        {
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const int8_t>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec)  
        {
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const int16_t>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec)  
        {
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const int32_t>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec)  
        {
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const int64_t>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec)  
        {
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_typed_array(half_arg_t, 
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const float>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec)  
        {
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const double>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec)  
        {
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_begin_multi_dim(const jsoncons::span<const size_t>& shape,
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec) 
        {
        ...
        virtual JSONCONS_VISITOR_RET_TYP visit_end_multi_dim(const ser_context& context,
                                      std::error_code& ec) 
        {
            visit_end_array(context, ec);
            JSONCONS_VISITOR_RET_VAL
 ...
 template <typename CharT,typename Allocator>
    ...
    private:
        ...
        JSONCONS_VISITOR_RET_TYP visit_begin_object(semantic_tag tag, const ser_context& context, std::error_code& ec) override
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_begin_object(std::size_t length, semantic_tag tag, const ser_context& context, std::error_code& ec) override
        {
            if (level_stack_.back().is_key())
            {
                if (level_stack_.back().target() == target_t::buffer && level_stack_.back().count() > 0)
        ...
        JSONCONS_VISITOR_RET_TYP visit_end_object(const ser_context& context, std::error_code& ec) override
        {
            switch (level_stack_.back().target())
            {
                case target_t::buffer:
        ...
        JSONCONS_VISITOR_RET_TYP visit_begin_array(semantic_tag tag, const ser_context& context, std::error_code& ec) override
        {
            if (level_stack_.back().is_key())
            {
                if (level_stack_.back().target() == target_t::buffer && level_stack_.back().count() > 0)
        ...
        JSONCONS_VISITOR_RET_TYP visit_begin_array(std::size_t length, semantic_tag tag, const ser_context& context, std::error_code& ec) override
        {
            if (level_stack_.back().is_key())
            {
                if (level_stack_.back().target() == target_t::buffer && level_stack_.back().count() > 0)
        ...
        JSONCONS_VISITOR_RET_TYP visit_end_array(const ser_context& context, std::error_code& ec) override
        {
            switch (level_stack_.back().target())
            {
                case target_t::buffer:
        ...
        JSONCONS_VISITOR_RET_TYP visit_uint64(uint64_t value, semantic_tag tag, const ser_context& context, std::error_code& ec) override
        {
            if (level_stack_.back().is_key() || level_stack_.back().target() == target_t::buffer)
            {
                key_.clear();
        ...
        JSONCONS_VISITOR_RET_TYP visit_int64(int64_t value, semantic_tag tag, const ser_context& context, std::error_code& ec) override
        {
            if (level_stack_.back().is_key() || level_stack_.back().target() == target_t::buffer)
            {
                key_.clear();
        ...
        JSONCONS_VISITOR_RET_TYP visit_half(uint16_t value, semantic_tag tag, const ser_context& context, std::error_code& ec) override
        {
            if (level_stack_.back().is_key() || level_stack_.back().target() == target_t::buffer)
            {
                key_.clear();
        ...
        JSONCONS_VISITOR_RET_TYP visit_double(double value, semantic_tag tag, const ser_context& context, std::error_code& ec) override
        {
            if (level_stack_.back().is_key() || level_stack_.back().target() == target_t::buffer)
            {
                key_.clear();
        ...
        JSONCONS_VISITOR_RET_TYP visit_bool(bool value, semantic_tag tag, const ser_context& context, std::error_code& ec) override
        {
            if (level_stack_.back().is_key() || level_stack_.back().target() == target_t::buffer)
            {
                key_.clear(); 
        ...
        JSONCONS_VISITOR_RET_TYP visit_null(semantic_tag tag, const ser_context& context, std::error_code& ec) override
        {
            if (level_stack_.back().is_key() || level_stack_.back().target() == target_t::buffer)
            {
                key_.clear(); 
        ...
        JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const uint8_t>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec) override 
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const uint16_t>& s, 
            semantic_tag tag, 
            const ser_context& context, 
            std::error_code& ec) override  
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const uint32_t>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec) override 
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const uint64_t>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec) override 
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const int8_t>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec) override  
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const int16_t>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec) override  
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const int32_t>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec) override  
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const int64_t>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec) override  
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_typed_array(half_arg_t, 
            const jsoncons::span<const uint16_t>& s, 
            semantic_tag tag, 
            const ser_context& context, 
            std::error_code& ec) override  
        ...
        JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const float>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec) override  
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_typed_array(const jsoncons::span<const double>& s, 
            semantic_tag tag,
            const ser_context& context, 
            std::error_code& ec) override  
        {
    ...
    private:
        ...
        JSONCONS_VISITOR_RET_TYP visit_begin_object(std::size_t, semantic_tag, const ser_context&, std::error_code&) override
        {
            JSONCONS_VISITOR_RET_VAL
        }
        ...
        JSONCONS_VISITOR_RET_TYP visit_begin_array(std::size_t, semantic_tag, const ser_context&, std::error_code&) override
        {
            JSONCONS_VISITOR_RET_VAL
        }
        ...
        JSONCONS_VISITOR_RET_TYP visit_string(const string_view_type&, semantic_tag, const ser_context&, std::error_code&) override
        {
            JSONCONS_VISITOR_RET_VAL
        }

        JSONCONS_VISITOR_RET_TYP visit_byte_string(const byte_string_view&, semantic_tag, const ser_context&, std::error_code&) override
        {
            JSONCONS_VISITOR_RET_VAL
        }

        JSONCONS_VISITOR_RET_TYP visit_uint64(uint64_t, semantic_tag, const ser_context&, std::error_code&) override
        {
            JSONCONS_VISITOR_RET_VAL
        }

        JSONCONS_VISITOR_RET_TYP visit_int64(int64_t, semantic_tag, const ser_context&, std::error_code&) override
        {
            JSONCONS_VISITOR_RET_VAL
        }

        JSONCONS_VISITOR_RET_TYP visit_half(uint16_t, semantic_tag, const ser_context&, std::error_code&) override
        {
            JSONCONS_VISITOR_RET_VAL
        }

        JSONCONS_VISITOR_RET_TYP visit_double(double, semantic_tag, const ser_context&, std::error_code&) override
        {
            JSONCONS_VISITOR_RET_VAL
        }

        JSONCONS_VISITOR_RET_TYP visit_bool(bool, semantic_tag, const ser_context&, std::error_code&) override
        {
            JSONCONS_VISITOR_RET_VAL
        }
    };
