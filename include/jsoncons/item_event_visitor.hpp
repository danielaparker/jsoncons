...
namespace jsoncons { 
    ...
    class basic_item_event_visitor_to_visitor_adaptor;

    template <class CharT>
    class basic_item_event_visitor 
    {
        template <class Ch, class Allocator>
        friend class basic_item_event_visitor_to_visitor_adaptor;
    public:
 ...
 template <class CharT, class Allocator>
    class basic_item_event_visitor_to_visitor_adaptor : public basic_item_event_visitor<CharT>
    {
    public:
    ...
    private:
        ...
        basic_item_event_visitor_to_visitor_adaptor(const basic_item_event_visitor_to_visitor_adaptor&) = delete;
        basic_item_event_visitor_to_visitor_adaptor& operator=(const basic_item_event_visitor_to_visitor_adaptor&) = delete;
    public:
        explicit basic_item_event_visitor_to_visitor_adaptor(const Allocator& alloc = Allocator())
        ...
        explicit basic_item_event_visitor_to_visitor_adaptor(basic_json_visitor<char_type>& visitor, 
    ...
    using item_event_visitor_to_visitor_adaptor = basic_item_event_visitor_to_visitor_adaptor<char>;
