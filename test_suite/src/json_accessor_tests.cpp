...
BOOST_AUTO_TEST_CASE(test_is)
{
    ...
    BOOST_CHECK(obj["field1"].type() == jsoncons::value_types::longlong_t);
    BOOST_CHECK(obj["field2"].type() == jsoncons::value_types::longlong_t);
    BOOST_CHECK(obj["field3"].type() == jsoncons::value_types::ulonglong_t);
...
BOOST_AUTO_TEST_CASE(test_is2)
{
    ...
    BOOST_CHECK(obj["field1"].type() == jsoncons::value_types::ulonglong_t);
