...
EUR_LIBOR_06M,2015-10-27,0.0000001
    ...
    SECTION("n_rows test")
    {
        ...
        REQUIRE(staj_event_flags::begin_array == cursor.current().event_type());
        cursor.next();

        REQUIRE(staj_event_flags::begin_array == cursor.current().event_type());
        cursor.next();
        REQUIRE(staj_event_flags::string_value == cursor.current().event_type());
        ...
        cursor.next();
        REQUIRE(staj_event_flags::end_array == cursor.current().event_type());
        cursor.next();
        ...
        cursor.next();
        REQUIRE(staj_event_flags::double_value == cursor.current().event_type());
        cursor.next();
        REQUIRE(staj_event_flags::end_array == cursor.current().event_type());
        cursor.next();
    ...
    SECTION("n_objects test")
    {
        ...
        REQUIRE(staj_event_flags::begin_object == cursor.current().event_type());
        cursor.next();
        REQUIRE(staj_event_flags::key == cursor.current().event_type());
        CHECK(cursor.current().get<std::string>() == std::string("index_id"));
        cursor.next();
        REQUIRE(staj_event_flags::string_value == cursor.current().event_type());
        CHECK(cursor.current().get<std::string>() == std::string("EUR_LIBOR_06M"));
        ...
        REQUIRE(staj_event_flags::double_value == cursor.current().event_type());
        cursor.next();
        REQUIRE(staj_event_flags::end_object == cursor.current().event_type());
        cursor.next();
...
TEST_CASE("csv_cursor header, subfield no terminating new line test")
{
    ...
    SECTION("test 1")
    {
        ...
        REQUIRE(staj_event_flags::begin_array == cursor.current().event_type());
        cursor.next();
        REQUIRE(staj_event_flags::uint64_value == cursor.current().event_type());
        CHECK(4 == cursor.current().get<int>());
        cursor.next();
        REQUIRE(staj_event_flags::int64_value == cursor.current().event_type());
