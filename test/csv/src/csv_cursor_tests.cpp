...
EUR_LIBOR_06M,2015-10-27,0.0000001
    ...
    SECTION("n_rows test")
    {
        ...
        REQUIRE(staj_event_types::begin_array == cursor.current().event_type());
        cursor.next();

        REQUIRE(staj_event_types::begin_array == cursor.current().event_type());
        cursor.next();
        REQUIRE(staj_event_types::string_value == cursor.current().event_type());
        ...
        cursor.next();
        REQUIRE(staj_event_types::end_array == cursor.current().event_type());
        cursor.next();
        ...
        cursor.next();
        REQUIRE(staj_event_types::double_value == cursor.current().event_type());
        cursor.next();
        REQUIRE(staj_event_types::end_array == cursor.current().event_type());
        cursor.next();
    ...
    SECTION("n_objects test")
    {
        ...
        REQUIRE(staj_event_types::begin_object == cursor.current().event_type());
        cursor.next();
        REQUIRE(staj_event_types::key == cursor.current().event_type());
        CHECK(cursor.current().get<std::string>() == std::string("index_id"));
        cursor.next();
        REQUIRE(staj_event_types::string_value == cursor.current().event_type());
        CHECK(cursor.current().get<std::string>() == std::string("EUR_LIBOR_06M"));
        ...
        REQUIRE(staj_event_types::double_value == cursor.current().event_type());
        cursor.next();
        REQUIRE(staj_event_types::end_object == cursor.current().event_type());
        cursor.next();
...
TEST_CASE("csv_cursor header, subfield no terminating new line test")
{
    ...
    SECTION("test 1")
    {
        ...
        REQUIRE(staj_event_types::begin_array == cursor.current().event_type());
        cursor.next();
        REQUIRE(staj_event_types::uint64_value == cursor.current().event_type());
        CHECK(4 == cursor.current().get<int>());
        cursor.next();
        REQUIRE(staj_event_types::int64_value == cursor.current().event_type());
...
struct remove_mark_csv_filter
{
    ...
    {
        if (event.event_type()  == staj_event_types::key &&
...
TEST_CASE("csv_cursor with filter tests")
{
    ...
    CHECK(filtered_c.current().event_type() == staj_event_types::begin_array);
    filtered_c.next();
    REQUIRE_FALSE(filtered_c.done());
    CHECK(filtered_c.current().event_type() == staj_event_types::begin_object);
    filtered_c.next();
    REQUIRE_FALSE(filtered_c.done());
    CHECK(filtered_c.current().event_type() == staj_event_types::key);
    filtered_c.next();
    REQUIRE_FALSE(filtered_c.done());
    CHECK(filtered_c.current().event_type() == staj_event_types::uint64_value);
    filtered_c.next();
    REQUIRE_FALSE(filtered_c.done());
    CHECK(filtered_c.current().event_type() == staj_event_types::key);
    filtered_c.next();
    REQUIRE_FALSE(filtered_c.done());
    CHECK(filtered_c.current().event_type() == staj_event_types::string_value);
    filtered_c.next();
    REQUIRE_FALSE(filtered_c.done());
    CHECK(filtered_c.current().event_type() == staj_event_types::key);
    filtered_c.next();
    ...
    filtered_c.next();
    REQUIRE_FALSE(filtered_c.done());
    CHECK(filtered_c.current().event_type() == staj_event_types::end_object);
    filtered_c.next();
    REQUIRE_FALSE(filtered_c.done());
    CHECK(filtered_c.current().event_type() == staj_event_types::begin_object);
    filtered_c.next();
    ...
    filtered_c.next();
    REQUIRE_FALSE(filtered_c.done());
    CHECK(filtered_c.current().event_type() == staj_event_types::end_array);
    filtered_c.next();
