...
TEST_CASE("decode_traits primitive")
{
    ...
    SECTION("uint64_t")
    {
        ...
        auto result = reflect::decode_traits<uint64_t>::decode(make_alloc_set(), cursor);
        REQUIRE(result);
    ...
    SECTION("vector of uint64_t")
    {
        ...
        json_string_cursor cursor(input);
        auto result = reflect::decode_traits<std::vector<uint64_t>>::decode(make_alloc_set(), cursor);
        REQUIRE(result);
...
TEST_CASE("decode_traits std::string")
{
    ...
    SECTION("string")
    {
        ...
        json_string_cursor cursor(input);
        auto result = reflect::decode_traits<std::string>::decode(make_alloc_set(), cursor);
        REQUIRE(result);
