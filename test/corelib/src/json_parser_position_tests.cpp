...
namespace {
    ...
    public:
        ...
        JSONCONS_VISITOR_RET_TYP visit_key(const string_view_type& key, const ser_context&, std::error_code&) override
        {
            if (!current_.empty())
            {
        ...
        JSONCONS_VISITOR_RET_TYP visit_string(const string_view_type&, jsoncons::semantic_tag, const jsoncons::ser_context& context, std::error_code&) override
        {
        ...
        JSONCONS_VISITOR_RET_TYP visit_uint64(uint64_t, semantic_tag, const ser_context& context, std::error_code&) override
        {
            custom_visit(context);
            JSONCONS_VISITOR_RET_VAL
        }

        JSONCONS_VISITOR_RET_TYP visit_int64(int64_t, semantic_tag, const ser_context& context, std::error_code&) override
        {
            custom_visit(context);
            JSONCONS_VISITOR_RET_VAL
        }

        JSONCONS_VISITOR_RET_TYP visit_double(double, semantic_tag, const ser_context& context, std::error_code&) override
        {
            custom_visit(context);
            JSONCONS_VISITOR_RET_VAL
        }

        JSONCONS_VISITOR_RET_TYP visit_bool(bool, semantic_tag, const ser_context& context, std::error_code&) override
        {
            custom_visit(context);
            JSONCONS_VISITOR_RET_VAL
        }
