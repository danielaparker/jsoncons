...
[UndefinedBehaviorSanitizer (UBSan)](http://clang.llvm.org/docs/UndefinedBehaviorSanitizer.html) and [Valgrind](http://valgrind.org/) are enabled for selected gcc and clang builds.
