...
jsoncons uses some features that are new to C++ 11, particularly move semantics and the AllocatorAwareContainer concept, however, using conditional directives, it retains compatible with VC++ 10 SP1 (note that SP1 is required for VC++ 10, it fixes compiler bugs with move semantics.) It has been tested with MS Visual C++ 10 SP1, MS Visual C++ 15, clang 3.3 and GCC 4.8. 
