...
```
Or define and use your own filters. See [json_content_filter](https://github.com/danielaparker/jsoncons/blob/master/doc/ref/json_content_filter.md) for details.
<div id="A8"/>
### JSONPath
