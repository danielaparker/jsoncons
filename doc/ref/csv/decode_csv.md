...
int main()
{
    ...
    options.mapping_strategy(csv::mapping_kind::n_objects);
    std::ifstream is1("input/sales.csv");
    ojson j1 = csv::decode_csv<ojson>(is1,options);
    std::cout << "\n(1)\n"<< pretty_print(j1) << "\n";
...
"NY","LON","TOR";"LON"
    ...
    options2.mapping_strategy(csv::mapping_kind::n_rows)
           .subfield_delimiter(';');
    ...
    options3.assume_header(true)
           .mapping_strategy(csv::mapping_kind::m_columns)
           .subfield_delimiter(';');
...
2017-01-08,0.0063,0.0076,0.0084,0.0112
    ...
    ioptions.header_lines(1)
            .mapping_strategy(csv::mapping_kind::n_rows);
