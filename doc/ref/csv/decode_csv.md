...
int main()
{
    ...
    options.assume_header(true)
           .mapping_strategy(csv::mapping_strategy::n_objects);

    std::ifstream is1("input/sales.csv");
    ojson j1 = csv::decode_csv<ojson>(is1,options);
    std::cout << "\n(1)\n"<< pretty_print(j1) << "\n";

    options.mapping_strategy(csv::mapping_strategy::n_rows);
    std::ifstream is2("input/sales.csv");
    ojson j2 = csv::decode_csv<ojson>(is2,options);
    std::cout << "\n(2)\n"<< pretty_print(j2) << "\n";

    options.mapping_strategy(csv::mapping_strategy::m_columns);
...
int main()
{
    ...
    options.mapping_strategy(csv::mapping_strategy::n_objects);
    std::ifstream is1("input/sales.csv");
    ojson j1 = csv::decode_csv<ojson>(is1,options);
    std::cout << "\n(1)\n"<< pretty_print(j1) << "\n";
...
"NY","LON","TOR";"LON"
    ...
    options2.mapping_strategy(csv::mapping_strategy::n_rows)
           .subfield_delimiter(';');
    ...
    options3.assume_header(true)
           .mapping_strategy(csv::mapping_strategy::m_columns)
           .subfield_delimiter(';');
...
2017-01-08,0.0063,0.0076,0.0084,0.0112
    ...
    ioptions.header_lines(1)
            .mapping_strategy(csv::mapping_strategy::n_rows);
