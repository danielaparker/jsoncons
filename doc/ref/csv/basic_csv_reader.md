...
options.mapping_strategy(mapping_strategy::n_rows);
...
options.mapping_strategy(mapping_strategy::n_objects);
...
options.mapping_strategy(mapping_strategy::m_columns);
