...
options.mapping_strategy(csv_mapping_strategy::n_rows);
...
options.mapping_strategy(csv_mapping_strategy::n_objects);
...
options.mapping_strategy(csv_mapping_strategy::m_columns);
