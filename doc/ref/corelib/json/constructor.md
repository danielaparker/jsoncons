...
basic_json(const_json_ptr_arg, const basic_json* ptr);             (27) (since 1.8.0)

basic_json(json_ptr_arg, basic_json* ptr);                         (28) (since 1.8.0)
```
...
(6) Constructs a `basic_json` value for types supported in [json_traits](./reflect/json_traits.md).
...
(20) Constructs a `basic_json` value for types supported in [json_traits](./reflect/json_traits.md) with allocator.
