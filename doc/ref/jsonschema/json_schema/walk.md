...
<table>
  ...
  <tr>
    ...
    <pre>
[walk_result](../walk_result.md) fun(const std::string& keyword,
    const Json& schema, const uri& schema_location,
    const Json& instance, const jsonpointer::json_pointer& instance_location)</pre>
or
    <pre>
[walk_state](../walk_state.md) fun(const <a href="../schema_property.md">schema_property&lt;Json&gt;&</a> property,
...
#### Construct a type tree based on a JSON Schema and an instance (since 1.7.0)
