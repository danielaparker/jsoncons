...
TEST_CASE("test_cbor_parsing")
{
    ...
    check_parse_cbor({0xc1,0x1a,0x55,0x4b,0xbf,0xd3},
                  json(1431027667, semantic_tag::epoch_seconds));
}
...
TEST_CASE("Compare CBOR packed item and jsoncons item")
{
    ...
    encoder.int64_value(-1431027667, semantic_tag::epoch_seconds);
    encoder.double_value(1431027667.5, semantic_tag::epoch_seconds);
    encoder.end_array();
    encoder.flush();
    ...
    expected.emplace_back(1431027667, semantic_tag::epoch_seconds);
    expected.emplace_back(-1431027667, semantic_tag::epoch_seconds);
    expected.emplace_back(1431027667.5, semantic_tag::epoch_seconds);
