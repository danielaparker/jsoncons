...
TEST_CASE("test_move_constructor")
{
    ...
    //CHECK(storage_kind::null_value == var1.stored_type());
    CHECK(storage_kind::int64_value == var2.stored_type());
    CHECK(var2.as<int64_t>() == val1);

    uint64_t val3 = 9999;
    json var3(val3, semantic_tag::none);
    json var4(std::move(var3));
    //CHECK(storage_kind::null_value == var3.stored_type());
    CHECK(storage_kind::uint64_value == var4.stored_type());
    CHECK(var4.as<uint64_t>() == val3);

    double val5 = 123456789.9;
    json var5(val5, semantic_tag::none);
    json var6(std::move(var5));
    //CHECK(storage_kind::null_value == var5.stored_type());
    CHECK(storage_kind::double_value == var6.stored_type());
    ...
    CHECK(storage_kind::long_string_value == var8.stored_type());
    ...
    //CHECK(storage_kind::null_value == var9.stored_type());
    CHECK(storage_kind::short_string_value == var10.stored_type());
    CHECK(val9 == var10.as<std::string>());

    bool val11 = true;
    json var11(val11, semantic_tag::none);
    json var12(std::move(var11));
    //CHECK(storage_kind::null_value == var11.stored_type());
    CHECK(storage_kind::bool_value == var12.stored_type());
    ...
    //CHECK(storage_kind::null_value == var13.stored_type());
    CHECK(storage_kind::long_string_value == var14.stored_type());
    ...
    CHECK(storage_kind::null_value == var15.stored_type());
    CHECK(storage_kind::object_value == var16.stored_type());
    CHECK(val15 == var16);

    json::array val17 = {1,2,3,4};
    json var17(val17, semantic_tag::none);
    json var18(std::move(var17));
    CHECK(storage_kind::null_value == var17.stored_type());
    CHECK(storage_kind::array_value == var18.stored_type());
    CHECK(val17 == var18);
}
...
TEST_CASE("test_copy_constructor")
{
    ...
    json var3(val3, semantic_tag::none);
    json var4(var3);
    CHECK(storage_kind::uint64_value == var3.stored_type());
    CHECK(storage_kind::uint64_value == var4.stored_type());
    CHECK(var4.as<uint64_t>() == val3);
    ...
    json var5(val5, semantic_tag::none);
    json var6(var5);
    CHECK(storage_kind::double_value == var5.stored_type());
    CHECK(storage_kind::double_value == var6.stored_type());
    CHECK(var6.as<double>() == val5);
    ...
    json var9(val9.data(), val9.length(), semantic_tag::none);
    json var10(var9);
    CHECK(storage_kind::short_string_value == var9.stored_type());
    CHECK(storage_kind::short_string_value == var10.stored_type());
    ...
    json var11(val11, semantic_tag::none);
    json var12(var11);
    CHECK(storage_kind::bool_value == var11.stored_type());
    CHECK(storage_kind::bool_value == var12.stored_type());
    CHECK(var12.as<bool>() == val11);
    ...
    json var13(val13.data(), val13.length(), semantic_tag::none);
    json var14(var13);
    CHECK(storage_kind::long_string_value == var13.stored_type());
    CHECK(storage_kind::long_string_value == var14.stored_type());
    ...
    json var15(val15, semantic_tag::none);
    json var16(var15);
    CHECK(storage_kind::object_value == var15.stored_type());
    CHECK(storage_kind::object_value == var16.stored_type());
    CHECK(val15 == var16);
    ...
    json var17(val17, semantic_tag::none);
    json var18(var17);
    CHECK(storage_kind::array_value == var17.stored_type());
    CHECK(storage_kind::array_value == var18.stored_type());
    CHECK(val17 == var18);
}
