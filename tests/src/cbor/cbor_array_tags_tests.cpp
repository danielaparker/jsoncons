...
TEST_CASE("cbor tagged array tests")
{
    ...
    SECTION("Tag 83, float128, big endian")
    {
        ...
        const std::vector<uint8_t> input = {
            ...
            0x58,0x20, // Byte string value of length 32
                0xff,0xef,0xff,0xff,0xff,0xff,0xff,0xff,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                0x7f,0xef,0xff,0xff,0xff,0xff,0xff,0xff,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
        };
    ...
    SECTION("Tag 87, float128, little endian")
    {
        ...
        const std::vector<uint8_t> input = {
            ...
            0x58,0x20, // Byte string value of length 32
                0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xff,0xff,0xff,0xff,0xff,0xff,0xef,0xff,
