...
TEST_CASE("test_is")
{
    ...
    CHECK(obj["field1"].kind() == jsoncons::value_kind::int64_value);
    CHECK(obj["field2"].kind() == jsoncons::value_kind::int64_value);
    CHECK(obj["field3"].kind() == jsoncons::value_kind::uint64_value);
...
TEST_CASE("test_is2")
{
    ...
    CHECK(obj["field1"].kind() == jsoncons::value_kind::uint64_value);
