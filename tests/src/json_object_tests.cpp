...
TEST_CASE("test_is")
{
    ...
    CHECK(obj["field1"].physical_type() == jsoncons::physical_type_tag::integer_t);
    CHECK(obj["field2"].physical_type() == jsoncons::physical_type_tag::integer_t);
    CHECK(obj["field3"].physical_type() == jsoncons::physical_type_tag::uinteger_t);
...
TEST_CASE("test_is2")
{
    ...
    CHECK(obj["field1"].physical_type() == jsoncons::physical_type_tag::uinteger_t);
