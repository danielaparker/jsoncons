...
TEST_CASE("test_is")
{
    ...
    CHECK(obj["field1"].data_type() == jsoncons::data_type_tag::integer_t);
    CHECK(obj["field2"].data_type() == jsoncons::data_type_tag::integer_t);
    CHECK(obj["field3"].data_type() == jsoncons::data_type_tag::uinteger_t);
...
TEST_CASE("test_is2")
{
    ...
    CHECK(obj["field1"].data_type() == jsoncons::data_type_tag::uinteger_t);
