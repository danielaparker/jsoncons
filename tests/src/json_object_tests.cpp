...
TEST_CASE("test_is")
{
    ...
    CHECK(obj["field1"].underlying_type() == jsoncons::storage_type::int64_value);
    CHECK(obj["field2"].underlying_type() == jsoncons::storage_type::int64_value);
    CHECK(obj["field3"].underlying_type() == jsoncons::storage_type::uint64_value);
...
TEST_CASE("test_is2")
{
    ...
    CHECK(obj["field1"].underlying_type() == jsoncons::storage_type::uint64_value);
