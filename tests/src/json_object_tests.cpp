...
TEST_CASE("test_is")
{
    ...
    CHECK(obj["field1"].stored_type() == jsoncons::storage_kind::int64_value);
    CHECK(obj["field2"].stored_type() == jsoncons::storage_kind::int64_value);
    CHECK(obj["field3"].stored_type() == jsoncons::storage_kind::uint64_value);
...
TEST_CASE("test_is2")
{
    ...
    CHECK(obj["field1"].stored_type() == jsoncons::storage_kind::uint64_value);
