...
TEST_CASE("test_variant")
{
    ...
    CHECK(physical_type_tag::integer_t == var1.physical_type());
    json::variant var2(uint64_t(100));
    CHECK(physical_type_tag::uinteger_t == var2.physical_type());
    json::variant var3("Small string",12);
    CHECK(physical_type_tag::short_string_t == var3.physical_type());
    json::variant var4("Too long to fit in small string",31);
    CHECK(physical_type_tag::long_string_t == var4.physical_type());
    json::variant var5(true);
    CHECK(physical_type_tag::bool_t == var5.physical_type());
    json::variant var6;
    CHECK(physical_type_tag::empty_object_t == var6.physical_type());
    json::variant var7{ null_type() };
    CHECK(physical_type_tag::null_t == var7.physical_type());
    json::variant var8{ json::allocator_type() };
    CHECK(physical_type_tag::object_t == var8.physical_type());
    json::variant var9(123456789.9);
    CHECK(physical_type_tag::double_t == var9.physical_type());
}
...
TEST_CASE("test_move_constructor")
{
    ...
    //CHECK(physical_type_tag::null_t == var1.physical_type());
    CHECK(physical_type_tag::integer_t == var2.physical_type());
    CHECK(var2.integer_data_cast()->value() == val1);

    uint64_t val3 = 9999;
    json::variant var3(val3);
    json::variant var4(std::move(var3));
    //CHECK(physical_type_tag::null_t == var3.physical_type());
    CHECK(physical_type_tag::uinteger_t == var4.physical_type());
    CHECK(var4.uinteger_data_cast()->value() == val3);

    double val5 = 123456789.9;
    json::variant var5(val5);
    json::variant var6(std::move(var5));
    //CHECK(physical_type_tag::null_t == var5.physical_type());
    CHECK(physical_type_tag::double_t == var6.physical_type());
    ...
    //CHECK(physical_type_tag::null_t == var7.physical_type());
    CHECK(physical_type_tag::long_string_t == var8.physical_type());
    ...
    //CHECK(physical_type_tag::null_t == var9.physical_type());
    CHECK(physical_type_tag::short_string_t == var10.physical_type());
    ...
    //CHECK(physical_type_tag::null_t == var11.physical_type());
    CHECK(physical_type_tag::bool_t == var12.physical_type());
    ...
    //CHECK(physical_type_tag::null_t == var13.physical_type());
    CHECK(physical_type_tag::long_string_t == var14.physical_type());
    ...
    CHECK(physical_type_tag::null_t == var15.physical_type());
    CHECK(physical_type_tag::object_t == var16.physical_type());
    ...
    CHECK(physical_type_tag::null_t == var17.physical_type());
    CHECK(physical_type_tag::array_t == var18.physical_type());
...
TEST_CASE("test_copy_constructor")
{
    ...
    CHECK(physical_type_tag::uinteger_t == var3.physical_type());
    CHECK(physical_type_tag::uinteger_t == var4.physical_type());
    CHECK(var4.uinteger_data_cast()->value() == val3);
    ...
    CHECK(physical_type_tag::double_t == var5.physical_type());
    CHECK(physical_type_tag::double_t == var6.physical_type());
    CHECK(var6.double_data_cast()->value() == val5);
    ...
    CHECK(physical_type_tag::short_string_t == var9.physical_type());
    CHECK(physical_type_tag::short_string_t == var10.physical_type());
    ...
    CHECK(physical_type_tag::bool_t == var11.physical_type());
    CHECK(physical_type_tag::bool_t == var12.physical_type());
    CHECK(var12.bool_data_cast()->value() == val11);
    ...
    CHECK(physical_type_tag::long_string_t == var13.physical_type());
    CHECK(physical_type_tag::long_string_t == var14.physical_type());
    ...
    CHECK(physical_type_tag::object_t == var15.physical_type());
    CHECK(physical_type_tag::object_t == var16.physical_type());
    CHECK(val15 == var16.object_data_cast()->value());
    ...
    CHECK(physical_type_tag::array_t == var17.physical_type());
    CHECK(physical_type_tag::array_t == var18.physical_type());
    CHECK(val17 == var18.array_data_cast()->value());
}
