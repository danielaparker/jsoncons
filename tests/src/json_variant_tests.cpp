...
TEST_CASE("test_variant")
{
    ...
    CHECK(major_type_tag::integer_t == var1.major_type());
    json::variant var2(uint64_t(100));
    CHECK(major_type_tag::uinteger_t == var2.major_type());
    json::variant var3("Small string",12);
    CHECK(major_type_tag::short_string_t == var3.major_type());
    json::variant var4("Too long to fit in small string",31);
    CHECK(major_type_tag::long_string_t == var4.major_type());
    json::variant var5(true);
    CHECK(major_type_tag::bool_t == var5.major_type());
    json::variant var6;
    CHECK(major_type_tag::empty_object_t == var6.major_type());
    json::variant var7{ null_type() };
    CHECK(major_type_tag::null_t == var7.major_type());
    json::variant var8{ json::allocator_type() };
    CHECK(major_type_tag::object_t == var8.major_type());
    json::variant var9(123456789.9);
    CHECK(major_type_tag::double_t == var9.major_type());
}
...
TEST_CASE("test_move_constructor")
{
    ...
    //CHECK(major_type_tag::null_t == var1.major_type());
    CHECK(major_type_tag::integer_t == var2.major_type());
    CHECK(var2.integer_data_cast()->value() == val1);

    uint64_t val3 = 9999;
    json::variant var3(val3);
    json::variant var4(std::move(var3));
    //CHECK(major_type_tag::null_t == var3.major_type());
    CHECK(major_type_tag::uinteger_t == var4.major_type());
    CHECK(var4.uinteger_data_cast()->value() == val3);

    double val5 = 123456789.9;
    json::variant var5(val5);
    json::variant var6(std::move(var5));
    //CHECK(major_type_tag::null_t == var5.major_type());
    CHECK(major_type_tag::double_t == var6.major_type());
    ...
    //CHECK(major_type_tag::null_t == var7.major_type());
    CHECK(major_type_tag::long_string_t == var8.major_type());
    ...
    //CHECK(major_type_tag::null_t == var9.major_type());
    CHECK(major_type_tag::short_string_t == var10.major_type());
    ...
    //CHECK(major_type_tag::null_t == var11.major_type());
    CHECK(major_type_tag::bool_t == var12.major_type());
    ...
    //CHECK(major_type_tag::null_t == var13.major_type());
    CHECK(major_type_tag::long_string_t == var14.major_type());
    ...
    CHECK(major_type_tag::null_t == var15.major_type());
    CHECK(major_type_tag::object_t == var16.major_type());
    ...
    CHECK(major_type_tag::null_t == var17.major_type());
    CHECK(major_type_tag::array_t == var18.major_type());
...
TEST_CASE("test_copy_constructor")
{
    ...
    CHECK(major_type_tag::uinteger_t == var3.major_type());
    CHECK(major_type_tag::uinteger_t == var4.major_type());
    CHECK(var4.uinteger_data_cast()->value() == val3);
    ...
    CHECK(major_type_tag::double_t == var5.major_type());
    CHECK(major_type_tag::double_t == var6.major_type());
    CHECK(var6.double_data_cast()->value() == val5);
    ...
    CHECK(major_type_tag::short_string_t == var9.major_type());
    CHECK(major_type_tag::short_string_t == var10.major_type());
    ...
    CHECK(major_type_tag::bool_t == var11.major_type());
    CHECK(major_type_tag::bool_t == var12.major_type());
    CHECK(var12.bool_data_cast()->value() == val11);
    ...
    CHECK(major_type_tag::long_string_t == var13.major_type());
    CHECK(major_type_tag::long_string_t == var14.major_type());
    ...
    CHECK(major_type_tag::object_t == var15.major_type());
    CHECK(major_type_tag::object_t == var16.major_type());
    CHECK(val15 == var16.object_data_cast()->value());
    ...
    CHECK(major_type_tag::array_t == var17.major_type());
    CHECK(major_type_tag::array_t == var18.major_type());
    CHECK(val17 == var18.array_data_cast()->value());
}
