...
TEST_CASE("encode_ubjson_test")
{
    ...
    check_encode_ubjson({0xce,0,1,0x00,0x00},json(65536U));
    check_encode_ubjson({0xce,0xff,0xff,0xff,0xff},json(4294967295U));
    check_encode_ubjson({0xcf,0,0,0,1,0,0,0,0},json(4294967296U));
    check_encode_ubjson({0xcf,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff},json((std::numeric_limits<uint64_t>::max)()));

    check_encode_ubjson({0x01},json(1));
    check_encode_ubjson({0x0a},json(10));
    check_encode_ubjson({0x17},json(23)); 
    check_encode_ubjson({0x18},json(24)); 
    check_encode_ubjson({0x7f},json(127)); 

    check_encode_ubjson({0xcc,0xff},json(255));
    check_encode_ubjson({0xcd,0x01,0x00},json(256));
    check_encode_ubjson({0xcd,0xff,0xff},json(65535));
    check_encode_ubjson({0xce,0,1,0x00,0x00},json(65536));
    check_encode_ubjson({0xce,0xff,0xff,0xff,0xff},json(4294967295));
    check_encode_ubjson({0xcf,0,0,0,1,0,0,0,0},json(4294967296));
    check_encode_ubjson({0xcf,0x7f,0xff,0xff,0xff,0xff,0xff,0xff,0xff},json((std::numeric_limits<int64_t>::max)()));

    // negative fixint 0xe0 - 0xff
    check_encode_ubjson({0xe0},json(-32));
    check_encode_ubjson({0xff},json(-1)); //

    // negative integers
    check_encode_ubjson({0xd1,0xff,0},json(-256));
    check_encode_ubjson({0xd1,0xfe,0xff},json(-257));
    check_encode_ubjson({0xd2,0xff,0xff,0,0},json(-65536));
    check_encode_ubjson({0xd2,0xff,0xfe,0xff,0xff},json(-65537));
    check_encode_ubjson({0xd3,0xff,0xff,0xff,0xff,0,0,0,0},json(-4294967296));
    check_encode_ubjson({0xd3,0xff,0xff,0xff,0xfe,0xff,0xff,0xff,0xff},json(-4294967297));

    // null, true, false
    check_encode_ubjson({0xc0},json::null()); // 
    check_encode_ubjson({0xc3},json(true)); //
    check_encode_ubjson({0xc2},json(false)); //

    // floating point
    check_encode_ubjson({0xca,0,0,0,0},json(0.0));
    check_encode_ubjson({0xca,0xbf,0x80,0,0},json(-1.0));
    check_encode_ubjson({0xca,0xcb,0x7f,0xff,0xff},json(-16777215.0));
