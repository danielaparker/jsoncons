...
#ifndef JSONCONS_JSON_SERIALIZER_IMPL_HPP
#define JSONCONS_JSON_SERIALIZER_IMPL_HPP
...
template <class Char>
class basic_json_serializer_impl : public basic_json_serializer<Char>
{
    struct stack_item
    {
...
public:
    basic_json_serializer_impl(std::basic_ostream<Char>& os)
        : os_(os), indent_(0)
    {
    ...
    basic_json_serializer_impl(std::basic_ostream<Char>& os, basic_output_format<Char> format)
...
typedef basic_json_serializer_impl<char> json_serializer_impl;
