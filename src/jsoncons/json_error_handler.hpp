...
{
public:
    virtual ~basic_json_error_handler()
    {
    }
...
template <typename Char>
class default_basic_json_error_handler : public basic_json_error_handler<Char>
{
public:
    static basic_json_error_handler<Char>& instance()
    {
        static default_basic_json_error_handler<Char> instance;
        return instance;
    }
private:
    virtual void do_warning(std::error_code,
...
typedef basic_json_error_handler<char> json_error_handler;
typedef basic_json_error_handler<wchar_t> wjson_error_handler;

// Deprecated
typedef basic_json_error_handler<char> parse_error_handler;
typedef basic_json_error_handler<wchar_t> wparse_error_handler;

typedef default_basic_json_error_handler<char> default_json_error_handler;
typedef default_basic_json_error_handler<wchar_t> wdefault_json_error_handler;
