...
The woutput_format class is an instantiation of the basic_output_format class template that uses char as the character type.
...
### Constructors
    ...
    woutput_format()
Constructs an `woutput_format` with default values. 
...
The default is `true`
    ...
    std::wstring nan_replacement() const 
The default is L"null"

    std::wstring pos_inf_replacement() const 
The default is L"null"

    std::wstring neg_inf_replacement() const 
The default is L"null"
...
### Modifiers
    ...
    void nan_replacement(const std::wstring& replacement)

    void pos_inf_replacement(const std::wstring& replacement)

    void neg_inf_replacement(const std::wstring& replacement)
